...
class ezpI18n
{
    ...
    */
    ...
    protected static function translateText( $context, $source, $comment = null, $arguments = null )
    {
        ...
        $hash = nxcTranslationsHelper::isTranslationsEditorEnabled()
            ? nxcTranslationsFile::getMessageHash( $context, $source, $comment )
            : null;

        $man = eZTranslatorManager::instance();
        $trans = $man->translate( $context, $source, $comment );
        if ( $trans !== null ) {
            return self::insertArguments( $trans, $arguments ) . $hash;
        }
        ...
        return self::insertArguments( $source, $arguments ) . $hash;
    }
}
